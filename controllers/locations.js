    ...
    '/:location_id/manage/:groupuserclass_id': {
        'post': {
            ...
            route: function manageUserclassAtLocation(req, res) {
                manageUserclassAtLocationOrSublocation(req, res);
            }
        },
        'delete': {
            auth: ['group owner', 'or', 'privileged group member', 'or', 'privileged location member'],
            route: function dontManageUserclassAtLocation(req, res) {
                unmanageUserclassAtLocationOrSublocation(req, res);
            }
        }
    },
    '/:location_id/sublocation/:sublocation_id/manage/:groupuserclass_id': {
        'post': {
            auth: ['group owner', 'or', 'privileged group member', 'or', 'privileged location member'],
            route: function manageUserclassAtLocation(req, res) {
                manageUserclassAtLocationOrSublocation(req, res);
...
function manageUserclassAtLocationOrSublocation(req, res) {
    Bookshelf.transaction(function(t) {
        var sqlOptions = {
            transacting: t
        };
        return models.ManagingClassesAtLocation.query(function(q) {
            ...
            if (req.params.sublocation_id) {
                q.andWhere('managingclassesatlocations.sublocation_id', '=', req.params.sublocation_id)
            } else {
                q.andWhere('managingclassesatlocations.location_id', '=', req.params.location_id)
            }
        })
            .fetch(sqlOptions)
                        ...
                        .tap(function(groupid) {
                            if (groupid) {
                                ...
                                function createManagingClassesAtLocation(usergroup_id) {
                                    ...
                                    var bannedKeys = undefined;
                                    if (req.params.sublocation_id) {
                                        data.sublocation_id = req.params.sublocation_id;
                                        bannedKeys = ['location_id'];
                                    } else {
...
function unmanageUserclassAtLocationOrSublocation(req, res) {
