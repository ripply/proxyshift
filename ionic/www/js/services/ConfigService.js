...
var config_data = {
    ...
    'STATES': {
        ...
        'EXPIRED_CALLOUTS': 'app.expiredcallouts',
        'EXPIRED_MANAGE': 'app.expiredmanage',
        'EXPIRED_MY_SHIFTS': 'app.expiredmyshifts',
        'EXPIRED_PENDING_APPROVAL': 'app.expiredpendingapproval',
        'EXPIRED_NO_APPLICATIONS': 'app.expirednoapplications',
        'EXPIRED_APPROVED': 'app.expiredapproved',
